...
public class PostFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.text.setOnClickListener(v -> {
            binding.text.setColorFilter(ContextCompat.getColor(requireContext(), R.color.appColor), android.graphics.PorterDuff.Mode.SRC_IN);
            binding.camera.setColorFilter(ContextCompat.getColor(requireContext(), R.color.dark_grey), android.graphics.PorterDuff.Mode.SRC_IN);
            binding.voice.setColorFilter(ContextCompat.getColor(requireContext(), R.color.dark_grey), android.graphics.PorterDuff.Mode.SRC_IN);

            changeFragment(new TypeSearchFragment());
        });

        binding.camera.setOnClickListener(v -> {
            binding.text.setColorFilter(ContextCompat.getColor(requireContext(), R.color.dark_grey), android.graphics.PorterDuff.Mode.SRC_IN);
            binding.camera.setColorFilter(ContextCompat.getColor(requireContext(), R.color.appColor), android.graphics.PorterDuff.Mode.SRC_IN);
            binding.voice.setColorFilter(ContextCompat.getColor(requireContext(), R.color.dark_grey), android.graphics.PorterDuff.Mode.SRC_IN);

            changeFragment(new ImageSearchFragment());
        });

        binding.voice.setOnClickListener(v -> {
            binding.text.setColorFilter(ContextCompat.getColor(requireContext(), R.color.dark_grey), android.graphics.PorterDuff.Mode.SRC_IN);
            binding.camera.setColorFilter(ContextCompat.getColor(requireContext(), R.color.dark_grey), android.graphics.PorterDuff.Mode.SRC_IN);
            binding.voice.setColorFilter(ContextCompat.getColor(requireContext(), R.color.appColor), android.graphics.PorterDuff.Mode.SRC_IN);

            changeFragment(new VoiceSearchFragment());
        });
...
//
    ...
    private void setData(){
        ...
        transaction.replace(R.id.frameSearch, fragment, null);
